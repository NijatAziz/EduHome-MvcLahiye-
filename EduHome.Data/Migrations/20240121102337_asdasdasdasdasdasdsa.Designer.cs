...
namespace EduHome.Data.Migrations
{
    ...
    [Migration("20240121102337_asdasdasdasdasdasdsa")]
    partial class asdasdasdasdasdasdsa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryCourse", b =>
                {
                    b.HasOne("EduHome.Core.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduHome.Core.Entities.Course", null)
                        .WithMany()
