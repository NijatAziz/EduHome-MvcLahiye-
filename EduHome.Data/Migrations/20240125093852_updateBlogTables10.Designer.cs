...
namespace EduHome.Data.Migrations
{
    ...
    [Migration("20240125093852_updateBlogTables10")]
    partial class updateBlogTables10
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Core.Entities.TagBlog", b =>
                {
                    b.HasOne("EduHome.Core.Entities.Blog", null)
                        .WithMany("TagBlogs")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduHome.Core.Entities.Tag", null)
                        .WithMany("TagBlogs")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
